...
display = Entry(window, font="Arial 20 bold", bg='#1c3ec7', fg='white',
                width=19)
display.pack()
...
btn_9 = Button(panel, bg='orange', bd=0, text="9",
               font='Arial 16 bold', width=5, height=3, command=lambda: inserir("4"))
btn_limpar: Button = Button(panel, bg='orange', bd=0, text="C",
                         font='Arial 16 bold', width=5, height=3, command=limpar)
btn_igual = Button(panel, bg='orange', bd=0, text="=",
                 font='Arial 16 bold', width=5, height=3, command=calcular)
